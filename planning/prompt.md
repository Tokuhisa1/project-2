...
- **jQuery `ajax`**: (**post-MVP**, but highly encouraged) Your app will need to make a third-party API call using jQuery `ajax` from the front-end.
    ...
    - [Our own DRESSELHAUS quotes API](https://dresselhaus-quotes-api.herokuapp.com/)
...
- Wireframes - detail the flow of your app through simple wireframes
  ...
  * Refer back to the [todo app wireframes](https://git.generalassemb.ly/wdi-nyc-dresselhaus/express-todo-app/blob/master/wireframes.md) for an example of what we expect!
...
* *Start Planning* - 11:00PM on Monday, August 28th - Choose a project and begin planning
* *Project Approvals* - 12:30PM on Tuesday, August 29th - Wireframes (like [the todo app wireframe examples](https://git.generalassemb.ly/wdi-nyc-dresselhaus/express-todo-app/blob/master/wireframes.md)), user stories, database structure.
* *First Check-in* - with squad leader on Wednesday, August 30th - Project board, which API you plan to use.
* *Second Check-in* - 12:00PM on Friday, September 1st - Git repo, routes structure, initial Heroku deployment.
* *Stand Ups* - Every day in the morning with your squad leader
* *Presentations* - 09:00AM on Tuesday, September 5th
...
- A **presentation** in class that:
    - Is **exactly 5** minutes in length
...
* __Project Workflow__: Did you complete the user stories, wireframes as specified above? Did you use source control (Git) as expected for the phase of the program you’re in (detailed above)? Did you submit your project via an issue ticket on GHE? (Gading scale: 0-3)

* __Technical Requirements__: Did you deliver a project that met all the technical requirements? Given what the class has covered so far, did you build something that was reasonably complex? (Grading scale: 0-3)

* __Creativity__: Did you added a personal spin or creative element into your project submission?

* __Code Quality__: Did you follow code style guidance and best practices covered in class, such as spacing, modularity, and semantic naming? Did you comment your code as your instructors have in class? (Grading scale: 0-3)

* __Deployment__: Did you deploy your application to a public url using Heroku? (Grading scale: 0-1)
...
**Total passing score that meets expectations: 7.**
...
### Go, Get it!!
![motivation](https://slack-imgs.com//mc?c=1&url=https%3A%2F%2Fi.redd.it%2F7593yrkzhgiz.jpg)
